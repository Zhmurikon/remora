"""Локальный stdio-коннектор: вся авторизация и бизнес-логика остаются в JSON API."""
...
from app.schemas.courses import CourseCopyRequest, CoursePublication, CourseStructureWrite
