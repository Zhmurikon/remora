...
Статус: **E1 в работе** — каркас собран, базовый API аутентификации реализован; пользовательские экраны ещё не готовы. [Состояние и оставшиеся задачи](docs/05-status.md).
