...
E1 в работе: базовый API аутентификации реализован, фронтенд и усиление защиты ещё впереди.
Состояние и ближайшие задачи — `docs/05-status.md`, полный план — `docs/03-roadmap.md`.
